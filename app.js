...
let sessions = [];
let activeSessionId = localStorage.getItem('xamo_active_session_id') || null;
...
// Automatic Session Restoration on Reopening XAMO
window.addEventListener('DOMContentLoaded', () => {
  const lastActiveId = localStorage.getItem('xamo_active_session_id');
  const storedSessions = JSON.parse(localStorage.getItem(getChatStorageKey()) || '[]');
  if (lastActiveId && storedSessions.some(s => String(s.id) === String(lastActiveId))) {
